...
public class SearchProductAction implements Action {
    private ActionResult searchResult = new ActionResult("search");
    public static final Logger log = LoggerFactory.getLogger(SearchProductAction.class);
    @Override
